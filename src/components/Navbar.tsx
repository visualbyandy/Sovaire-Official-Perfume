...
export default function Navbar({ cartCount, onOpenCart, onNavigateTo, searchQuery, onSearchChange }: NavbarProps) {
      ...
      <header className="sticky top-0 z-40 bg-white/95 backdrop-blur-md border-b border-[#C5A059]/20 shadow-xs">
        ...
        <div className="hidden md:grid grid-cols-3 items-center max-w-7xl mx-auto px-6 md:px-8 h-20 md:h-22 relative">
          ...
          <div className="flex items-center gap-6 justify-start">
            <div className="flex items-center gap-3 select-none pr-4 border-r border-[#C5A059]/20">
              <div className="w-8 h-[14px] flex flex-col justify-between cursor-pointer group" onClick={() => setIsMenuOpen(true)}>
                <span className="h-[1px] w-full bg-[#C5A059] transition-all group-hover:w-full"></span>
                <span className="h-[1px] w-2/3 bg-[#C5A059] transition-all group-hover:w-full"></span>
                <span className="h-[1px] w-full bg-[#C5A059] transition-all group-hover:w-full"></span>
              </div>
              <span className="text-[10px] uppercase tracking-[0.2em] text-[#C5A059] font-sans leading-none font-medium">Menu</span>
            </div>
          ...
          <div className="flex flex-col items-center justify-center select-none">
            ...
            >
              ...
              <span className="text-[8px] lg:text-[9px] uppercase tracking-[0.3em] mr-[-0.3em] text-[#C5A059] mt-0.5 lg:-mt-1 group-hover:text-gold-800 transition-colors">
